...
/**
 * return a Log object for logging and a Hook object
 ...
 */
func NewLoggerWithTestHook(service string) (Logger, *logrusTest.Hook) {
	logger := log.New()
	...
	return &Log{entry}, logrusTest.NewLocal(logger)
}
